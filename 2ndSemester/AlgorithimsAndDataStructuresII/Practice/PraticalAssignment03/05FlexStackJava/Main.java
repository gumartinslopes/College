...
/*
 Trabalho Prático 03 questão 05
...
public class Main{
  ...
  public static TrackStack myTracks = new TrackStack();
     ...
     String id = new String();
      do{
        ...
        if(id.compareTo("FIM") != 0)
          myTracks.push(getRegister(totalSearchById(id)));
  ...
  public static void operate(String input)throws Exception{
    ...
    if(operation.charAt(0) == 'I')
      myTracks.push(getRegister(totalSearchById(commands[1])));
...
class TrackStack{
  ...
  //metodo que mostra a pilha ao contrario
  public void displayBackwards(){
    displayBackwards(top, getLength() - 1);
  } 

  public void displayBackwards(Cell i, int j){
    if(i.next != null)
      displayBackwards(i.next, j - 1);
    MyIO.println("[" + (j++) + "] " + i.element.toString());
  }

  //metodo de insercao no final
  public void push(Music m){
    Cell aux = new Cell(m);
    aux.next = top;
    top = aux;
    aux = null;
