...
int main(){
  ...
  createlog("690773_insercaoParcial.txt", comp, mov, execution_time);
...
//decisao apenas pelo id pois eh um valor unico por musica
bool decide(Music* a, Music* b){
  return (strcmp(a->id, b->id) > 0) ? true : false;
}

//funcao que utiliza a ordemacao parcial por selecao
