/*
O grupo, após uma densa discussão, análise e vários testes de desempenho, concluiu que 
a melhor configuração para o melhor desempenho é de 4 threads, escalonamento guiado e 
divisão de scheduling igual 100. Abaixo estão os testes realizados:

OBS: A função que apresentou maior gargalo de execução foi a compute_path. Como
é chamada duas vezes, foi realizada uma soma de seus tempos.

### Base
 - Threads: 2
 - Tempo de Execução: 0.866652
 - Tempo de Função:  0.179395 + 0.685690 = 0.865085
 - Tipo de Scheduling: None
 - Divisão do Scheduling: None

### Teste 1
 - Threads: 2
 - Tempo de Execução: 0.739337
 - Tipo de Scheduling: Dynamic
 - Divisão do Scheduling: 100
 - Function time compute_path= 0.149142 + 0.586441 = 0.735583

 ### Teste 2
 - Threads: 2
 - Tempo de Execução: 0.746678
 - Tipo de Scheduling: Static
 - Divisão do Scheduling: 100
 - Function time compute_path= 0.139537 + 0.604606 = 0.744143

 ### Teste 3
- Threads: 2
 - Tempo de Execução: 0.708615
 - Tipo de Scheduling: Guided
 - Divisão do Scheduling: 100
 - Function time compute_path = 0.14454 + 0.561555 = 0.706095
 
### Teste 4
- Threads: 3
 - Tempo de Execução: 0.991843
 - Tipo de Scheduling: Guided
 - Divisão do Scheduling: 100
 - Function time compute_path = 0.128793 + 0.587001 = 0.715794

### Teste 5
- Threads: 4 (máximo de threads)
 - Tempo de Execução: 0.718626
 - Tipo de Scheduling: Guided
 - Divisão do Scheduling: 100
 - Function time compute_path = 0.186565 + 0.800593 = 0.987158
*/
...
void compute_path(vector<Flight> &flights, string to, vector<Travel> &travels, unsigned long t_min, unsigned long t_max, Parameters parameters)
{
  ...
  double end = omp_get_wtime();
  printf("\nFunction time compute_path= %f", end - start);
}
